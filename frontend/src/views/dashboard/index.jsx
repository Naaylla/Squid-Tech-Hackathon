...
export default function Login() {
    return (
        ...
        <p className="text-2xl text-gray-900 font-bold text-center">Suivi de l'impact écologique</p>
          ...
          <LineChart></LineChart>
              ...
              <div className="flex h-[20vh] flex-col w-[50vw]">
               ...
               <p className="text-black text-xl ml-5 mt-[10vh]">
                ...
                <div className="radial-progress text-green-300" style={{ "--value": "50", "--size": "7rem", "--thickness": "10px" }} role="progressbar">
          ...
          <div className="flex w-full  items-center justify-center">
              <div className="md:w-[60vw] h-[25vh] rounded-lg shadow-md bg-white   flex flex-col  font-bold font-[Inter] border-2 border-gray-100">
              ...
              <div className="flex h-[20vh] flex-col w-[50vw]">
               ...
               <p className="text-black text-xl ml-5 mt-[10vh]">
                ...
                <div className="radial-progress text-green-300" style={{ "--value": "50", "--size": "8rem", "--thickness": "10px" }} role="progressbar">
                    <p className="text-3xl">
                        50%
                        </p>
                    </div>
