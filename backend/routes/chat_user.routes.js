...
router_chat_user.post('/add', verify_Token, add_chat_user)
router_chat_user.delete('/delete/:id_chat/:id_user', verify_Token, delete_chat_user)
router_chat_user.put('/update/:id_chat/:id_user', verify_Token, update_chat_user)
