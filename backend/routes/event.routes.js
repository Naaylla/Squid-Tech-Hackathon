...
router_event.get('/:id_event/:id_user', get_event)
router_event.post('/add', add_event)
router_event.delete('/delete/:id_event/:id_user', delete_event)
router_event.put('/update/:id_event/:id_user', update_event)
